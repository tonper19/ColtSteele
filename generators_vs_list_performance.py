...
Output:
*** generator comprehension calculating the sum of the first 9999999999
49999999985000000001
*** list comprehension calculating the sum of the first 9999999999
49999999985000000001
...
print("*** generator comprehension calculating the sum of the first 9999999999")
print(sum(n for n in range(9999999999)))
generator_time = time.time() - generator_start_time

list_start_time = time.time()
print("*** list comprehension calculating the sum of the first 9999999999")
print(sum(n for n in range(9999999999)))
